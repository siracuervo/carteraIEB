...
export const obtenerDatosCartera = cache(async function obtenerDatosCartera(diaSeleccionado = null, diaTenenciaSeleccionado = null) {
  ...
  // si no hay cotización ni precioManual, usar el último cierre manual
  {
    ...
    // Un cierre guardado a mano (cierresManuales.json, ej. SPCX) pisa el vivo
    // fuera de rueda: es el precio que fijó el usuario y vale hasta que abra
    // la próxima sesión (BYMA 10:30–17:00 ART), no solo hasta el cambio de día.
