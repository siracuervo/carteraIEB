...
import { leerTransacciones, leerClasificaciones, leerPortafolioHistorial, leerCierresDiarios, mergeCierresDiarios, leerMovimientosFondos, leerPatrimonioAuto, guardarPatrimonioAuto } from "./storage.js";
import {
  calcularTenencias,
...
export const obtenerDatosCartera = cache(async function obtenerDatosCartera(diaSeleccionado = null, diaTenenciaSeleccionado = null) {
  const [transacciones, overrides, portafolioHistorial, movimientosFondos, patrimonioAuto] = await Promise.all([
    leerTransacciones(),
    leerClasificaciones(),
