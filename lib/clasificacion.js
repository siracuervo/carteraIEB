 ...
 * o, peor, el logo de otra empresa — ej. TEAM devuelve ORMAT en vez de Atlassian) — se
 ...
 * MRVL, TEAM o KEEL. Si aparece un ticker nuevo sin logo (o con logo equivocado), alcanza con sumarlo acá. */
export const TICKERS_SIN_LOGO = new Set([
  "KEEL", "MRVL", "NOW", "TEAM", "BYMA", "COME", "GBAN", "METR", "PAMP", "VALO", "YPFD", "A3", "AUSO", "ECOG", "IEBC",
]);
