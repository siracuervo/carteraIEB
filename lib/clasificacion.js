...
/**
 * Política anti-logos-equivocados (default-deny): parqet.com se usa SOLO para
 * estos tickers verificados. Ya nos devolvió 404 o, peor, el logo de otra
 * empresa (TEAM→ORMAT, SPCX→otro fondo), así que cualquier ticker nuevo o no
 * listado muestra directamente la inicial — nunca una imagen incorrecta.
 * Si entra un ticker nuevo y se verifica su logo en parqet, se lo suma acá.
 */
export const LOGOS_PARQET_OK = new Set([
  "ABBV", "ADBE", "ADP", "AMZN", "ANET", "ARM", "AVGO", "AXP", "C", "CAT",
  "CRWD", "CRWV", "GGAL", "GOOGL", "HOOD", "HPQ", "IBM", "INTC", "IREN",
  "LLY", "LRCX", "MELI", "MP", "MRK", "MRNA", "MSFT", "MU", "NBIS", "NU",
  "NVDA", "PATH", "RKLB", "SNOW", "TSLA", "TWLO", "VIST", "VST", "WDC",
]);

/**
 * Logos explícitos por ticker (se prueban antes que parqet): para empresas sin
 * logo útil en parqet pero con favicon oficial reconocible (vía Google S2).
 * Si la URL falla, se sigue con parqet (solo LOGOS_PARQET_OK) y luego la inicial.
 */
export const LOGO_POR_TICKER = {
  NOW: "https://www.google.com/s2/favicons?domain=servicenow.com&sz=128",
  SPCX: "https://www.google.com/s2/favicons?domain=spacex.com&sz=128",
};
