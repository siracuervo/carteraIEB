...
/** Tickers que ya sabemos que no tienen logo útil en el proveedor externo (parqet.com devuelve 404
 * o, peor, el logo de otra empresa — ej. TEAM devuelve ORMAT en vez de Atlassian, SPCX devuelve
 * otro fondo en vez del CEDEAR de SpaceX) — se evita el pedido de red y se muestra directamente
 * la inicial, en vez de depender de `onError`.
 * Mayormente acciones locales argentinas que ese proveedor no cubre, más algún caso suelto como
 * MRVL, TEAM, SPCX o KEEL. Si aparece un ticker nuevo sin logo (o con logo equivocado), alcanza con sumarlo acá. */
export const TICKERS_SIN_LOGO = new Set([
  "KEEL", "MRVL", "NOW", "SPCX", "TEAM", "BYMA", "COME", "GBAN", "METR", "PAMP", "VALO", "YPFD", "A3", "AUSO", "ECOG", "IEBC",
]);
