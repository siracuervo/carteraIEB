      ...
      for (const lista of listas) {
        for (const b of lista || []) {
          ...
          porSimbolo.set(simbolo, {
            ...
            // operado (bonos: el ask mete ruido en días sin operatoria).
 ...
 * feed directo de BYMA vía data912 (un bloque por listado) y, si un ticker no
 * está, cae a Yahoo probando el símbolo tal cual y con sufijo .BA.
...
export async function obtenerTipoCambioDolares() {
  ...
  resultado.ccl = await obtenerCCLDolarito();
